        ...
        <div className='w-full bg-slate-900 text-gray-300 py-8 px-2'> 
            <div className='max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8'>
                ...
                <div className='col-span-2 pt-8 md:pt-2'>
                    ...
                    <p className='py-4'>The latest news, resources, sent to your inbox weekly</p>
                    <form className='flex flex-col sm:flex-row'>
                        <input type='email' placeholder='Enter email' className='w-full p-2 mr-4 rounded-md mb-4 text-slate-900'/>
